...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \ProcurantFullId \if\ChangementPrenom0 et j'ai r\'{e}cemment obtenu mon changement de pr\'{e}nom à l'\'{E}tat-Civil \fi et je souhaite effectuer les d\'{e}marches de changement \if\ChangementPrenom0 de pr\'{e}nom et \fi de civilit\'{e} dans les registres du service scolarit\'{e} de \ProcurantEcole.
    ...
    Enfin, je vous prie de bien vouloir m'indiquer quelle proc\'{e}dure je dois effectuer afin d'obtenir une version \'{a} jour, en terme \if\ChangementPrenom0 de pr\'{e}nom et \fi de civilit\'{e}, de mes dipl\^{o}mes.
