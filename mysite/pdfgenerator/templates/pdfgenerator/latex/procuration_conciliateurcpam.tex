...
%-% remplacer par votre lettre de motivation
    ...
    Par cette procuration valable du \DebutProc {} jusqu'au \FinProc, le mandataire est en droit d'effectuer toutes les d\'{e}marches n\'{e}cessaires afin de faire valoir mon changement de \if\ChangementPrenom0 pr\'{e}nom et \fi de civilit\'{e}.
%-----------------------------------------------%
% Le blabla pas int\'{e}ressant                     %
%-----------------------------------------------%
...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \if\PersonGender0 mandat\'{e}e \else mandat\'{e} \fi par \ProcurantFullId \if\ChangementPrenom0 qui a r\'{e}cemment obtenu son changement de pr\'{e}nom à l'\'{E}tat-Civil \fi afin d'effectuer les d\'{e}marches de changement \if\ChangementPrenom0 de pr\'{e}nom et \fi de civilit\'{e} dans les registres de la CPAM du \ProcurantDepartement.
    ...
    Faute d'une rapide modification de ces informations et d'un prompt retour de votre part, je me verrais \if\PersonGender0 contrainte \else contraint \fi de saisir le Défenseur des Droits et la CNIL.
