...
\newcommand{\ProcurantNumero}{ {{- cleaned_data["numero"] -}} } % numero pole emploi
\newcommand{\ProcurantEntity}{ {{- cleaned_data["entite"] -}} } % entite pole emploi
...
%-% \`{\`{a}} remplacer par votre lettre de motivation
    Je suis \ProcurantFullId \if\ChangementPrenom0 et j'ai r\'{e}cemment obtenu mon changement de pr\'{e}nom \`{a} l'\'{E}tat-Civil \fi et je souhaite effectuer les d\'{e}marches de changement \if\ChangementPrenom0 de pr\'{e}nom et \fi de civilit\'{e} dans les registres de Pôle Emploi (\ProcurantEntity).

    \if\ChangementPrenom0
    \medskip

    Je suis \if\ProcurantGender0 connue \else connu \fi de vos services sous le nom de \ProcurantOldId et j'ai le num\'{e}ro \ProcurantNumero.
