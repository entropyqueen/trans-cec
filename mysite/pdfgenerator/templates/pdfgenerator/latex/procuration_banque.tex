...
\newcommand{\Civilite}{
    ...
    Pour toutes ces raisons, je vous demande de mettre \`{a} jour, dans les plus brefs d\'{e}lais, \if\ChangementPrenom0 le pr\'{e}nom et \fi la civilit\'{e} de \ProcurantId {} dans vos registres, et de me tenir inform\'{e}e par retour de courrier \'{e}lectronique de la bonne prise en compte de ces informations.
}
...
\conc{Demande de changement de \if\ChangementPrenom0 pr\'{e}nom et \fi de civilit\'{e} d'une personne transgenre}
    \opening{Madame, Monsieur,}
%-----------------------------------------------%
% Le corps de la lettre de motivation           %
% à vous de jouer !                             %
...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \if\PersonGender0 mandat\'{e}e \else mandat\'{e} \fi par \ProcurantFullId \if\ChangementPrenom0 qui a r\'{e}cemment obtenu son changement de pr\'{e}nom à l'\'{E}tat-Civil \fi afin d'effectuer les d\'{e}marches de changement \if\ChangementPrenom0 de pr\'{e}nom et \fi de civilit\'{e} dans les registres du service client de \ProcurantBanque.
