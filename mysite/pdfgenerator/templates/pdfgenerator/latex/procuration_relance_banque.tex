...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \if\PersonGender0 mandat\'{e}e \else mandat\'{e} \fi par \ProcurantFullId qui a r\'{e}cemment obtenu son changement de pr\'{e}nom à l'\'{E}tat-Civil afin d'effectuer les d\'{e}marches de changement \if\ChangementPrenom0 de pr\'{e}nom et \fi de civilit\'{e} dans les registres du service client de \ProcurantBanque.
    ...
    \medskip
    Je \fi
    vous demandais de bien vouloir changer sa civilit\'{e} de \if\ProcurantGender0 \og Monsieur \fg{} à \og Madame \fg{} \else \og Madame \fg{} à \og Monsieur \fg{} \fi dans vos registres, et ce pr\'{e}alablement à toute d\'{e}cision de changement de mention de sexe à l'\'{E}tat-Civil, puisqu'il s'agit d'une personne transgenre.
...
%-% \cc{Listes des autres destinataires}
    \encl{Copie des pi\`{e}ces d'identit\'{e} de \ProcurantId, \PersonId, procuration de \ProcurantId {} \if\ChangementPrenom0et d\'{e}cision de changement de pr\'{e}nom de \ProcurantId\fi}
